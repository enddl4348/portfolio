...
include $SKIN_DIR."/inc/header.inc"; 				// 상단디자인
	...
	<tr>
		<td align="center">
			...
			<table width="98%">
				...
				<tr><td height="10"></td></tr>
				<tr>
					<td width="30%"><a href="javascript:history.go(-1);"><img src="<?=$SKIN_URL?>/images/btn_list.gif" border="0"></a></td>
					<td align="center">
						<?=$cancel_btn?>
						<?=$escrow_btn?>
					</td>
...
include $SKIN_DIR."/inc/footer.inc"; 		// 하단디자인
