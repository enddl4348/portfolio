...
<div class="button_common">
  <button type="button" class="btn_grat_big" onClick="launchCrossPlatform()" >결제하기</button>
	<!-- <input type="button" class="btn_grat_big" value="결제하기" onClick="launchCrossPlatform()" /> -->
