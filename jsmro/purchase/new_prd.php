...
function delBbs(){
	...
	if(selbbs == ""){
		...
		if(confirm("선택한 게시물을 정말 삭제하시겠습니까?")){
			document.location = "new_prd_save.php?<?=$param?>&page=<?=$page?>&mode=delbbs&selbbs=" + selbbs;
		}
	}
}
//-->
...
<h2 class="page_ttl"><?=$bbs_info[title]?></small></h2>
      ...
      <tr><td class="t_rd" colspan="20"></td></tr>
		...
		<form>
			...
			<tr>
				...
				<td align="center"><a href="./new_prd_input.php?mode=update&idx=<?=$row['idx']?>&<?=$param?>&page=<?=$page?>" class="AW-btn-s">상세보기</a></td>
			  </tr>
    ...
    <table width="100%" height="10" border="0" cellpadding="0" cellspacing="0">
        ...
        <td width="33%">
            ...
            <a href="new_prd_input.php?<?=$param?>" class="AW-btn">글쓰기</a>
        </td>
